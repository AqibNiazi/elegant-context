...
//Create context is a function that creates a context object. This object can be used to provide and consume values in a React application.
export const CartContext = createContext({
  ...
  updateItemQuantity: (id) => {}, //This is the default value for the context that helps to get better auto completion.
